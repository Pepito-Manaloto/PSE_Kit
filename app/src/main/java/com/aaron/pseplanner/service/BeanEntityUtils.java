...
public final class BeanEntityUtils
{
    ...
    public static TradeDto fromTradeToTradeDto(Trade trade)
    {
        ...
        return new TradeDto(trade.getSymbol()).setId(trade.getId())
                ...
                .setProjectedAveragePrice(new BigDecimal(trade.getProjectedAveragePrice()))
                .setProjectedTotalAmount(new BigDecimal(trade.getProjectedTotalAmount()))
                .setProjectedGainToTarget(new BigDecimal(trade.getProjectedGainToTarget()))
                .setProjectedLossToStopLoss(new BigDecimal(trade.getProjectedLossToStopLoss()))
    ...
    public static Trade fromTradeDtoToTrade(TradeDto tradeDto)
    {
        ...
        return new Trade()
                ...
                .setProjectedAveragePrice(tradeDto.getProjectedAveragePrice().toPlainString())
                .setProjectedTotalAmount(tradeDto.getProjectedTotalAmount().toPlainString())
                .setProjectedGainToTarget(tradeDto.getProjectedGainToTarget().toPlainString())
                .setProjectedLossToStopLoss(tradeDto.getProjectedLossToStopLoss().toPlainString())
